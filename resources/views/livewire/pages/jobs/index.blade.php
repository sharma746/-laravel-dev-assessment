                            ...
                            @foreach ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <!-- Trigger Livewire delete action with job ID -->
                                        <button wire:click="deleteJob({{ $job['id'] }})" class="text-sm px-3 py-1.5 rounded hover:bg-slate-100 transition-colors text-red-500">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
